...
### وضوح وحدات الزمن
- استبدال اختصارات الزمن العربية غير الواضحة في القوائم بكلمات كاملة: دقيقة، ساعة، يوم، أسبوع، شهر، وسنة.

## [2.5.0] - 2026-09-10

### خط ثمانية وتجربة RTL
- إضافة `Thmanyah Sans` بخمسة أوزان محلية إلى مدير الخطوط وجعله الخط الافتراضي للنظام.
- إصلاح مسار الترجمة الديناميكية ليحافظ على المسافات في سجل النشاط خلال الفحص الأولي والتحديثات اللاحقة.
- إضافة تباعد منطقي متوافق مع RTL وLTR بين الفعل واسم المستخدم ووصف الحدث والتوقيت.
- دعم تعطيل تطبيق الخط داخل الواجهات المضمّنة التي تستخدم نظام خطوط مستقلًا.

### الترجمة والجودة
- تصحيح `Payment Reconciliation` إلى «تسوية المدفوعات».
- توسيع ملف الترجمة إلى 3,495 مصطلحًا صالحًا.
- تحديث مفاتيح أصول CSS وJavaScript لكسر الكاش بعد الترقية.
