...
app_include_js = ["/assets/arabic_pro/js/arabic_pro_font.js?v=20260728a"]
app_include_css = ["/assets/arabic_pro/css/arabic_pro_font.css?v=20260728a"]
web_include_js = "/assets/arabic_pro/js/arabic_pro_font.js?v=20260728a"
web_include_css = "/assets/arabic_pro/css/arabic_pro_font.css?v=20260728a"
